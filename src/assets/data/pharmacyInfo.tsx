...
const pharmacyInfo = [
    {
      ...
      {
        id: "02",
        pharmaciesName: " Ibaka Pharmacy",
        address: "2, Uyo Road, Uyo, Akwa Ibom.",
        location: "Uyo",
        type:"pharmacies",
        shortDesc:
          "Operates 24/7HRS and offers affordable services.",
      ...
      },
      {
        ...
        shortDesc:
          "Operates 24/7HRS and offers affordable services.",
        description:
          "we offer afforadble medical services with modern equipment!",
        reviews: [
          {
            rating: 4.8,
            text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
      ...
      {
        id: "27",
        pharmaciesName: "Adefemi Pharmacy",
